...
@onready var texture0: Texture2D = preload("res://assets/dialogs/dialog_mayor/balon_1.png")
@onready var texture1: Texture2D = preload("res://assets/dialogs/dialog_mayor/balon_2.png")
@onready var texture2: Texture2D = preload("res://assets/dialogs/dialog_mayor/balon_3.png")
@onready var texture3: Texture2D = preload("res://assets/dialogs/dialog_mayor/balon_4.png")
...
func _on_mayor_area_3d_body_entered(body):
...
func _on_mayor_area_3d_body_exited(body):
	if (body.name=="Player"):
		var node_mesh = get_node("MeshInstance3D")
